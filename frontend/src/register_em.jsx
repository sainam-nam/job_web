...
function Register_em() {
    ...
    return (
      <div>
        ...
        <img src="/register_em.png" className="hidden md:block md:w-70 md:mx-5 lg:block lg:w-130 lg:mr-10" />
          ...
          <div className="flex flex-col items-center py-5 px-2">
            <a className="card-title items-center text-[#8E80FF] text-2xl mb-5 lg:text-3xl lg:mb-5">ลงทะเบียน</a>
              <div className="relative flex items-center mb-3">
                <button onClick={() => navigate("/register")} className="z-0 btn btn-sm bg-white text-[#8E80FF] border-[#8E80FF] border-3 rounded-full px-5 hover:w-50  lg:text-sm">หางานและทำจิตอาสา</button>
                <button onClick={() => navigate("/register_em")} className="z-10 -ml-5 btn btn-sm bg-[#8E80FF] border-[#8E80FF] px-5 rounded-full hover:w-50 lg:text-sm">หาคนและจิตอาสา</button>
              </div>
