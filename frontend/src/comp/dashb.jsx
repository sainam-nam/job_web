...
export default function Dashboard() {
    return(
        ...
        <div className="flex space-x-4">
          <Link to="/Admin/Dashboard"><button className="px-4 py-2 bg-purple-600 text-white rounded-lg">งาน</button></Link>
          <Link to="/Admin/Dashboardvolun"><button className="px-4 py-2 bg-gray-200 text-gray-600 rounded-lg">กิจกรรมจิตอาสา</button></Link>
        </div>

        {/* สถิติข้อมูล */}
        <div className="grid grid-cols-4 gap-4 mt-6">
          <div className="p-4 bg-white shadow-md rounded-lg text-center">
            <p className="text-xl text-purple-600 font-bold">584</p>
