...
function Job_Post() {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch(`http://localhost:8081/jobpost?post_id=${id}`);
        ...
        <div className="bg-white px-5 py-3 md:px-15 md:py-6 lg:px-25 lg:py-12 xl:px-35 xl:py-14">
          <div className="flex flex-col justify-center w-full mb-2 p-4 md:mb-4 md:p-8 lg:mb-8 lg:p-10 xl:p-14 bg-[#D9D9D9] text-[#7B6ADA] rounded-3xl lg:rounded-4xl" style={{ boxShadow: '0 0 10px rgba(0,0,0,0.2)' }}>
            <div className="flex justify-between items-center">
              <p className="text-xs md:text-xl lg:text-3xl xl:text-5xl font-bold">{data[0]?.position_name}</p>
              ...
              <table>
                <tbody>
                  <tr className="lg:h-10 xl:h-12">
                    ...
                    <td className="w-40 md:w-80 lg:w-90 xl:w-100"><a className="text-[10px] md:text-sm lg:text-xl xl:text-2xl text-[#7B6ADA]">{data[0]?.salary} บาท/เดือน</a></td>
                  </tr>
                  <tr className="lg:h-10 xl:h-12">
                  ...
                  <tr className="lg:h-10 xl:h-12">
                    <td><FaCircle color="#7B6ADA" size={12} /></td>
                    <td><a className="text-[10px] md:text-sm lg:text-xl xl:text-2xl text-[#7B6ADA]">สถานที่ทำงาน</a></td>
          ...
          <div className="py-2 md:py-4 lg:py-6">
            ...
            <div className="text-[10px] md:text-sm lg:text-xl xl:text-2xl text-[#7B6ADA] ml-4 md:ml-10">{data[0]?.benefits}</div>
          </div>
          <div className="py-2 md:py-4 lg:py-6">
