...
function ForgetPassword() {
    ...
    return (
        <div>
        <Navbar_login />
            <div className="flex justify-center bg-[#7B6ADA]">
                <div className="card bg-white w-96 p-2 sm:w-110 lg:w-160 shadow-md my-40 md:my-40 md:mr-5 lg:my-30 lg:p-5 rounded-4xl">
                    <div className="flex flex-col items-center py-5 px-2">
                        <a className="card-title items-center text-[#7B6ADA] text-2xl mb-5 lg:text-3xl lg:mb-5">ลืมรหัสผ่าน</a>
                        
                        <form onSubmit={handleSubmit}>
                            <div className="flex flex-col items-center">
                            <div className="flex flex-col">
                                <label className="text-[#7B6ADA] font-bold">อีเมล</label>
                                    <input 
                                    type="email" 
                                    ...
                                    required
                                />
                                <p className="text-[#7B6ADA] text-[10px]">ระบบจะส่งลิงก์สำหรับเปลี่ยนรหัสผ่านไปยังอีเมลของคุณ</p>
                            </div>
                            <button className="btn bg-[#7B6ADA] border-[#7B6ADA] rounded-xl my-2 hover:border-5">ส่ง</button>
