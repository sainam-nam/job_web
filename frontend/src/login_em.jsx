          ...
          <div className="flex flex-col items-center py-5 px-2">
            <a className="card-title items-center text-[#7B6ADA] text-2xl mb-5 lg:text-3xl lg:mb-5">เข้าสู่ระบบ</a>
              <div className="relative flex items-center mb-3">
                <button onClick={() => navigate("/login")} className="z-0 btn btn-sm bg-white text-[#7B6ADA] border-[#7B6ADA] border-3 rounded-full px-5 hover:w-50  lg:text-sm">หางานและทำจิตอาสา</button>
                <button onClick={() => navigate("/login_em")} className="z-10 -ml-5 btn btn-sm bg-[#7B6ADA] border-[#7B6ADA] px-5 rounded-full hover:w-50 lg:text-sm">หาคนและจิตอาสา</button>
              </div>
