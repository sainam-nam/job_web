...
export default function TermsModal({ show, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-20 z-50 flex justify-center items-center px-4">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-3xl max-h-[80vh] overflow-y-auto relative">
        <center>
            <div className="flex items-center rounded-4xl justify-center bg-[#7B6ADA] w-2/3 p-4">
                <h2 className="text-xl  text-white font-bold">เงื่อนไขข้อตกลงและนโยบายความเป็นส่วนตัว</h2>
            </div>
        </center>
        <h3 className="text-lg font-semibold mt-4 text-[#7B6ADA]">1. การยอมรับเงื่อนไข</h3>
        ...
        <h3 className="text-lg font-semibold mt-4 text-[#7B6ADA]">2. การสมัครสมาชิกและบัญชีผู้ใช้</h3>
        <p className="text-sm text-gray-700 pl-5">
        ...
        <h3 className="text-lg font-semibold mt-4 text-[#7B6ADA]">3. การใช้งานที่ไม่เหมาะสม</h3>
        <p className="text-sm text-gray-700 pl-5">
        ...
        <h3 className="text-lg font-semibold mt-4 text-[#7B6ADA]">4. ความรับผิดชอบของผู้ใช้</h3>
        <p className="text-sm text-gray-700 pl-5">
        ...
        <hr className="my-4  text-[#7B6ADA]" />

        <h3 className="text-lg font-semibold mt-4 text-[#7B6ADA]">นโยบายความเป็นส่วนตัว</h3>

        <h4 className="font-semibold mt-2 text-[#7B6ADA]">1. ข้อมูลที่เราเก็บ</h4>
        <p className="text-sm text-gray-700 pl-5">
          เช่น ชื่อ, เพศ, วันเกิด, เบอร์โทร, อีเมล, ที่อยู่, รูปภาพ, พิกัด, การศึกษา, การทำงาน, ข้อมูลการสมัครงานและจิตอาสา
        </p>

        <h4 className="font-semibold mt-2 text-[#7B6ADA]">2. วัตถุประสงค์ของการเก็บข้อมูล</h4>
        <p className="text-sm text-gray-700 pl-5">
          ใช้ในการจับคู่งาน/กิจกรรม, พัฒนาบริการ, ติดต่อสื่อสาร
        </p>

        <h4 className="font-semibold mt-2 text-[#7B6ADA]">3. การเก็บรักษาข้อมูล</h4>
        <p className="text-sm text-gray-700 pl-5">
        ...
        <h4 className="font-semibold mt-2 text-[#7B6ADA]">4. สิทธิของผู้ใช้</h4>
        <p className="text-sm text-gray-700 pl-5">
          ผู้ใช้สามารถเข้าถึง แก้ไข หรือลบบัญชีของตนเองได้ และสามารถร้องขอให้ลบข้อมูลส่วนตัวได้ตลอดเวลา
        </p>

        <h4 className="font-semibold mt-2 text-[#7B6ADA]">5. ความปลอดภัยของข้อมูล</h4>
        <p className="text-sm text-gray-700 pl-5">
        ...
        <div className="flex justify-end mt-6">
          <button
            onClick={onClose}
            className="px-4 py-2 hover:bg-[#7B6ADA] hover:text-white rounded-xl bg-white text-[#7B6ADA] border border-3 border-[#7B6ADA]"
          >
            ปิด
          </button>
        </div>
