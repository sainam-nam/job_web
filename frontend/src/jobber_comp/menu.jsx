...
export default function Menu() {
    return(
        ...
        <ul className="menu bg-white rounded-3xl shadow-md w-61 ">
          ...
          <li><Link to="/Admin/HS" className="text-purple-600 text-lg hover:bg-gray-300 rounded-full">ทักษะด้านความรู้</Link></li>
          <li><Link to="/Admin/SS" className="text-purple-600 text-lg hover:bg-gray-300 rounded-full">ทักษะด้านอารมณ์</Link></li>
        </ul>
      </aside>
    )
}