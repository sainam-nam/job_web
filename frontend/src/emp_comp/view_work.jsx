    ...
    <div>
       <div className='text-[#8E80FF] bg-white rounded-3xl p-6 relative' style={{ boxShadow: '0 0 10px rgba(0,0,0,0.2)' }}>
            <div className="flex gap-4 items-center mb-4">
                <h2 className="font-bold text-xl">ข้อมูลการจ้างงาน</h2>
                <button onClick={() => navigate("/emp_profile/work/edit")} className="bg-[#8E80FF] text-white px-3 py-1 rounded-xl text-sm">
                    แก้ไข
                </button>
            </div>
            <div className="flex justify-center items-start mb-4">
                <div className="grid grid-cols-1 gap-4 text-sm">
                    <table className="table-auto w-full  text-lg overflow-hidden">
                        <tbody>
                            <tr>
                            <td className="font-bold p-3 ">เกี่ยวกับ</td>
                            <td className="p-3">
                              <div
                            ...
                            <tr className="">
                            <td className="font-bold p-3 ">สวัสดิการ</td>
                            <td className="p-3">
                              <div
                                className="prose prose-sm md:prose lg:prose-lg"
